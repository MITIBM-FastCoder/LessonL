...
PY_COT_CHAT_INSTRUCTION = "You are an AI that only responds with python code, NOT ENGLISH. You will be given a function signature and its docstring by the user. Write your full implementation (restate the function signature). Let's think step by step."
...
PY_TEST_GENERATION_CHAT_INSTRUCTION = """You are an AI coding assistant that can write unique, diverse, and intuitive unit tests for functions given the signature and docstring. Think about how to generate test cases correctly according to the function signature and comments."""
    ...
    def func_impl(
        ...
        if strategy == "mcts":
            ...
            return generic_generate_func_impl(
                ...
                reflection_few_shot=PY_REFLEXION_FEW_SHOT_ADD,
                simple_chat_instruction=PY_SIMPLE_CHAT_INSTRUCTION,
                cot_chat_instruction=PY_COT_CHAT_INSTRUCTION,
                reflection_completion_instruction=PY_REFLEXION_COMPLETION_INSTRUCTION,
                simple_completion_instruction=PY_SIMPLE_COMPLETION_INSTRUCTION,
                code_block_instruction=USE_PYTHON_CODEBLOCK_INSTRUCTION,
                parse_code_block=lambda x: parse_code_block(x, "python"),
